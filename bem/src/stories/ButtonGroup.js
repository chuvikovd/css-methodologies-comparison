    ...
    .add('Button Group', () =>
        <React.Fragment>
            <div className='button-group button-group__horizontal'>
                ...
                <button className='button button__primary button-group__button'>Button 2</button>
                <button className='button button__primary button-group__button'>Button 3</button>
            </div>
